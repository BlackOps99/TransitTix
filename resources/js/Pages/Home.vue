...
const submit = () => {
    form.transform(() => ({
        fromCity: form.fromCity.code,
        toCity: form.toCity.code,
        ...
        <div class="container relative">
            <div class="grid lg:grid-cols-12 mt-10 md:grid-cols-2 gap-2">
                <div class="lg:col-span-7">
                    ...
                    <p class="text-white opacity-50 mb-0 max-w-2xl text-lg">Book your bus with cash or your credit card
                            ...
                            <div class="grid grid-cols-1">
                                <div class="mb-5">
                                    <div class="flex flex-col">
                                        ...
                                        <Dropdown v-model="form.fromCity" :pt="{
                                    ...
                                    <InputError class="mt-2" :message="form.errors.fromCity"/>
                                </div>
                                <div class="mb-5">
                                    <div class="flex flex-col">
                                        <label class="dark:text-white mb-2">To</label>
                                        <Dropdown v-model="form.toCity" :pt="{
                                            root: { class: 'cursor-pointer text-black p-3 border border-[#ea580c] rounded-md' },
                                        }" :options="citiesTo" optionLabel="name" placeholder="Select a City"
                                                  class="mt-2"/>
                                    </div>
                                </div>
                                <div class="mb-5">
                                    <div class="flex flex-col">
                                        ...
                                        <Calendar placeholder="Select Date" v-model="form.date" :pt="{
