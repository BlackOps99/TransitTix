<template>
    <div>
        <section class="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="our_bus_classes">
            <div class="container">
                <div class="grid grid-cols-1 pb-8 text-center">
                    <h6 class="text-orange-600 font-bold uppercase mb-2">Our Bus Classes</h6>
                    <h3 class="mb-4 md:text-2xl text-xl font-medium dark:text-white">Our Bus</h3>

                    <p class="text-slate-400 dark:text-slate-300 max-w-xl mx-auto">Explore Egypt with the most booked classes.</p>
                </div>
